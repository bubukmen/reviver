...
class bkpcontrol:
	...
	def doglobal(self):
		print "Provádím " + self.chrTypZalohy  + " zálohu dat do souboru " + self.globalBkpFile
	...
	def domysql(self):
		...
		print "Provádím zálohu databáze MySQL do souboru " + nazevSouboru
	...
	def dopgsql(self):
		...
		print "Provádím zálohu databáze PostgreSQL do souboru " + nazevSouboru
